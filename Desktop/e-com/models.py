...
class Product(Model):
    ...
    pecentage_discount = fields.IntField()
    offer_expiration_data = fields.DateField(dafault = datetime.utcnow)
    product_image = fields.CharField(max_length=200, null = False, default = "productDefault.jpg")
    
    date_publisehd = fields.DatetimeField(default = datetime.utcnow)
